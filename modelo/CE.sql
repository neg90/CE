...
--
-- Servidor: localhost
-- Tiempo de generación: 27-06-2015 a las 20:36:30
...
CREATE TABLE IF NOT EXISTS `infmedidorexcel` (
  ...
  `cantinsertados` int(11) NOT NULL,
...
(946, 'ABELLEIRA FABIAN-LEN', '00015611812', 'COLON 239', '50', '484901', '7712', 1, '2015-06-27');
